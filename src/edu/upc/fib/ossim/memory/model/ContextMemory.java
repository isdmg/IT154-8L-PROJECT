...
public class ContextMemory {
    ...
    public Color getVirtualMemProcessColor(int start) {
        if (getByVirtualStart(start).getAllocated() != null)
            return getByVirtualStart(start).getAllocated().getParent().getColor();
        else return null;
    }
     ...
     * @see MemStrategy#addProcessComponents(ProcessComplete, Vector, int)
     */
    public void addProgram(Vector<Object> data, Vector<Vector> components, Object list, Object quantum) {
        // Add Program p to program's queue
     ...
     * @see MemStrategy#addProcessComponents(ProcessComplete, Vector, int)
     */
    public void updProgram(Vector<Object> data, Vector<Vector> components, Object list, Object quantum) {
        // Add Program p to program's queue
    ...
    private void releasePrograms(List<MemPartition> memory) {
        ...
        System.out.println(MemoryManagement.jList.toString());
        System.out.println(MemoryManagement.jIList.toString());
